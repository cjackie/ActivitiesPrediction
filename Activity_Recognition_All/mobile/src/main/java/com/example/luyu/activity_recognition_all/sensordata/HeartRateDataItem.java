 ...
 */
public class HeartRateDataItem implements SensorDataItem{

    final public static String PATH = "/activity_recognition/heart_rate";
    ...
    public HeartRateDataItem (double x, double time) {
        this.x = x;
        this.time = time;
    }
    ...
    public HeartRateDataItem setData(byte[] bytes) {
